   ...
   return (
      <div>
         ...
         <div id="abt-cnt" className="gradient-circles">
            <p>
               LEAD and MENTOR, founded by Engr. Sheriff Lamidi in 2014, at LEAD
               and MENTOR, we are dedicated to providing comprehensive support
               and guidance to young individuals on their journey towards
